  ...
  WebsiteText = {
    home: {
      ...
      about: {
        ...
        introductionText:
          "We make secure, efficient, SEO-friendly websites for information ans e-Commerce.",
        introductionCheckList1:
          "Our solutions include Website design, OCR for Arabic/English invoices and ID cards, Vehicle number plate recognition, Chatbots for customer service, Project-based coding classes, Graphics design, and one-stop solution for tendering on GeM.",
        introductionCheckList2:
          "We cater to a broad range of industries - Government, Hospitality, NGO, Pharmacy, Professionals, Restaurants, Speciality Food Retailers",
      ...
      featuresListData: [
        {
          ...
          title: "Web Design",
          description:
            "If achieving a balance between site uniqueness and user experience on one hand and lifecycle cost on the other is turning out to be hard then you came to the right place.  Our designs are secure, efficient, functionally rich and SEO-friendly.  Your website communicates your brand globally – we pay particular attention to navigation intuitiveness, typography, color balance and animation placements to leave a pleasing impression on your target audience.  We account for differences in browsing behavior on mobile devices and large screens right in the design stage.  We can substantially lower your third-party costs and upgrade costs using functionalities developed inhouse.  We work with the MERN stack.  Click here to check our portfolio. <a href='tel:+919867910690' style='cursor: pointer'>Call us</a>.  Let’s make it simple.",
          link: "/webDesign",
          img: WebDesign,
          imgmob: WebDesignMob,
        },
      ...
      CallToActionData: {
        ...
        description:
          "You have an IT solution need. Send us a message, call us or simply drop by for a time and price estimate to support your decision",
        btnText: "Contact Us",
      },
      counts: {
      ...
      team: {
        ...
        teamListData: [
          ...
          },
          {
            ...
            description:
              "He holds a Masters in Computer Science. He is a full stack developer. He mentors teams for delivery on client projects in machile learning, web and mobile technologies.",
          },
          {
            data_aos_delay: "300",
            img: team3,
            ...
            galleryData: [
              {
                ...
                class: "myImg88 myImg",
                altersrc:
                  gportfolio1_max /*altersrc means the maximized/enlarged image*/,
              },
              {
                id: "2" /* ratio 3:2*/,
                img: gportfolio2,
